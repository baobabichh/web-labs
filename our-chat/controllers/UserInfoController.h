...
class UserInfoController : public drogon::HttpController<UserInfoController>
{
  public:
    METHOD_LIST_BEGIN
      ADD_METHOD_TO(UserInfoController::getUserInfoGraph, "/get_user_info_graph", Post, "LoginFilter");
      ...
      ADD_METHOD_TO(UserInfoController::getOtherUserInfo, "/get_other_user_info", Get, "LoginFilter");
    ...
    void getUserInfoGraph(const HttpRequestPtr& req, std::function<void (const HttpResponsePtr &)> &&callback);
    ...
    void getOtherUserInfo(const HttpRequestPtr& req, std::function<void (const HttpResponsePtr &)> &&callback);
